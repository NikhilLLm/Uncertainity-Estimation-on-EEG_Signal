...
def run():
    ...
    dataset = 'BCI2a' # Options: 'BCI2a','HGD', 'CS2R', 'EEG_CSV'
    ...
    if dataset == 'BCI2a': 
        ...
        data_path = "/storage/pk_ajinkya/EEG-ATCNet/BCI/"
    ...
    train_conf = { 'batch_size': 32, 'epochs': 250, 'patience': 100, 'lr': 0.003,'n_train': 1,
